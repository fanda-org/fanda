...
passport.use(new LocalStrategy({ usernameField: 'userName' }, passportAccount.authenticate));
...
app.use('/contact-categories', require('./controllers/contact-categories.controller'));
...
app.use('/product-categories', require('./controllers/product-categories.controller'));
app.use('/product-segments', require('./controllers/product-segments.controller'));
app.use('/product-varieties', require('./controllers/product-varieties.controller'));
app.use('/products', require('./controllers/products.controller'));
app.use('/unit-conversions', require('./controllers/unit-conversions.controller'));

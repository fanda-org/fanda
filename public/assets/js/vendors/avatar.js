  ...
  (function() {
    function Avatar(element) {
      ...
      if (this.settings.useGravatar && this.settings.allowGravatarFallback) {
        ...
        this.settings.use_avatars_io &&
        (this.settings.avatars_io.user_id ||
          this.settings.avatars_io.twitter ||
          this.settings.avatars_io.facebook ||
          this.settings.avatars_io.instagram)
      ) {
        ...
        },
        {
          ...
          value: function initialAvatar() {
            ...
            if (context) {
              ...
              context.fill();
              context.font = ''
                .concat(this.settings.initial_weight, ' ')
                .concat(this.settings.initial_size || height / 2, 'px ')
                .concat(this.settings.initial_font_family);
        ...
        },
        {
          ...
          value: function gravatarValid() {
            ...
            if (this.settings.email) {
              image_source = 'https://secure.gravatar.com/avatar/'.concat(this.settings.email, '?d=404');
            }
      ...
      [
        {
          ...
          value: function gravatarUrl() {
            ...
            var hash = email_or_hash.match(/@/g) !== null ? email_or_hash : email_or_hash;
        ...
        },
        {
          ...
          value: function githubAvatar() {
            ...
            return 'https://avatars'
              .concat(cdn, '.githubusercontent.com/u/')
              .concat(settings.github_id || 0, '?v=3&s=')
              .concat(settings.size || 80);
          }
        },
        {
          key: 'avatarsioAvatar',
